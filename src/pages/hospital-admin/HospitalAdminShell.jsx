...
import { BarChart3, CalendarDays, CircleDollarSign, Gauge, ImagePlus, Images, Info, LayoutDashboard, LogOut, MessageSquareText, Settings, Stethoscope } from "lucide-react";
...
export default function HospitalAdminShell() {
  ...
  const items = useMemo(() => [
    ["/admin", "Dashboard", LayoutDashboard], ["/admin/hospital-info", "হাসপাতাল তথ্য", Info], ["/admin/doctors", "ডাক্তার", Stethoscope], ["/admin/services", "সার্ভিস", Gauge], ["/admin/costs", "খরচ", CircleDollarSign], ["/admin/slider", "ব্যানার স্লাইডার", ImagePlus], ["/admin/gallery", "গ্যালারি", Images], ["/admin/reviews", "রিভিউ", MessageSquareText], ["/admin/appointments", "অ্যাপয়েন্টমেন্ট", CalendarDays, pending], ["/admin/analytics", "Analytics", BarChart3], ["/admin/settings", "Settings", Settings],
  ], [pending]);
